...
sub_checkout-code(){
    ...
    # git clone https://truongbb96:<password>@git.myitsol.com/truongbb96/spring-ci-advanced.git
...
sub_quality-gate(){
    qualityGateStatus=$(curl --request POST \
        --url http://192.168.1.210:9000/api/qualitygates/project_status?projectKey=spring-ci-advanced \
